...
fun Double.clamp(max: Double, min: Float) = this.coerceAtLeast(min.toDouble()).coerceAtMost(max)
...
fun inverseLerp(first: Int, second: Int, factor: Float) = (factor.clamp(Math.max(first, second).toFloat(),
    Math.min(first, second).toFloat()) - first) / (second - first)

fun inverseLerp(first: Long, second: Long, factor: Float) = (factor.clamp(Math.max(first, second).toFloat(),
    Math.min(first, second).toFloat()) - first) / (second - first)
...
fun inverseLerp(first: Double, second: Double, factor: Float) = (factor.clamp(Math.max(first, second).toFloat(),
    Math.min(first, second).toFloat()) - first) / (second - first)
