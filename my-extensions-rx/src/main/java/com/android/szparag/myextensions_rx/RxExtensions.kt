...
internal val onErrorStub: (Throwable) -> Unit = { throw RuntimeException(it) }
internal val onCompleteStub: () -> Unit = {}

//private val realmOnSuccessStub by lazy { OnSuccess { } }
internal val COMPLETABLE_NULL_ERROR_THROWABLE_TEXT = "Completable object is null, pushing error value..."
internal val OBSERVABLE_NULL_VALUE_THROWABLE_TEXT = "Observable onNext() argument is null, pushing error value..."
internal val REALM_COMPLETABLE_NULL_EXCEPTION_THROWABLE_TEXT = "Realm transaction callback errored (with null exception)"
internal val DISPOSABLE_ALREADY_IN_CONTAINER = "Disposable is already in given container. Throwing exception"
internal val DISPOSABLE_CONTAINER_IS_NULL = "Disposable container is null. Throwing exception"
 ...
 */
fun Completable?.nonNull() = this ?: Completable.error { Throwable(COMPLETABLE_NULL_ERROR_THROWABLE_TEXT) }
...
fun <T> Observable<T>.flatMap(completable: Completable, onComplete: () -> Unit = onCompleteStub,
    onError: (Throwable) -> Unit = onErrorStub): Observable<T> {
