...
private const val NOT_IMPLEMENTING_MVI_VIEW_EXCEPTION_MESSAGE =
    "Inflated view is not implementing MviView<VS> interface. Double check whether your custom view extends BaseMviView(...) classes, screenData for this view is valid or whether layout resource has correct layout in top level tag (should be BaseMviConstraintLayout and not ConstraintLayout etc)."
...
class NotImplementingMviViewException : NavigatorException(NOT_IMPLEMENTING_MVI_VIEW_EXCEPTION_MESSAGE)
